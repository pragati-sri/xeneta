...
class ChromeDriver extends provider_1.ProviderClass {
    constructor(config) {
        super();
    ...
    async updateBinary(version, maxVersion) {
        ...
        const versionObj = version_list_1.getVersion(versionList, osHelper(this.osType, this.osArch), formatVersion(version), maxVersion);
