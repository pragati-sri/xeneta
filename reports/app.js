...
app.controller('ScreenshotReportController', function ($scope, $http) {
    ...
    var results = [
    {
        "description": "should create an Instrument Definition from an EDS file.|VFK-TC-712",
        "passed": false,
        "pending": false,
        "os": "Windows NT",
        "instanceId": 24836,
